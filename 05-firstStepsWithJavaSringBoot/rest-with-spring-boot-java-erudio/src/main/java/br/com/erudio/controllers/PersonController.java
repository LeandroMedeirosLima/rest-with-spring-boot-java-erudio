...
public class PersonController {
    ...
    @Operation(summary = "Disable a especific person by id", 
    description = "Disable a especific person by id", 
    tags = {"People"}, 
    responses = {
    ...
    public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findPersonsByName(
            ...
            @RequestParam(value = "size", defaultValue = "12") Integer size,
            @RequestParam(value = "direction", defaultValue = "asc") String direction) {
         //Teste de merge remoto
      //Resolvido o conflito = Teste de Merge + Teste de merge remoto
        var sortDirection = "desc".equalsIgnoreCase(direction) ? Direction.DESC : Direction.ASC;
