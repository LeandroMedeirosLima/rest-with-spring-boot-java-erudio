...
@Tag(name = "Book", description = "Endopoins for Managing Books")
public class BookController {
    ...
    @Operation(summary = "Finds all books", 
               description = "Endopoins for Managing Books", 
               tags = {"Book"}, 
               responses = {
                       @ApiResponse(description = "Success", 
                                    responseCode = "200", 
...
//                         MediaType.APPLICATION_XML, 
//                         MediaType.APPLICATION_YML})
//    @Operation(summary = "Finds a book by example", 
//    description = "Finds a book", 
//    tags = {"Book"}, 
//    responses = {
//            @ApiResponse(description = "Success", 
...
//            @ApiResponse(description = "Internal Error ", responseCode = "500", content = @Content)
//    })
//    public BookVO findByExample(@PathVariable(value = "id") Long id) {
//        return bookService.findById(id);
//    }
